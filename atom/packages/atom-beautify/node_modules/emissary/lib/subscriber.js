(function() {
  var Mixin, Signal, Subscriber, Subscription, WeakMap, _ref,
  ...
  module.exports = Subscriber = (function(_super) {
    ...
    Subscriber.prototype.unsubscribe = function(object) {
      ...
      if (object != null) {
        _ref3 = (_ref1 = (_ref2 = this._subscriptionsByObject) != null ? _ref2.get(object) : void 0) != null ? _ref1 : [];
        ...
        return (_ref4 = this._subscriptionsByObject) != null ? _ref4["delete"](object) : void 0;
      } else {
        _ref6 = (_ref5 = this._subscriptions) != null ? _ref5 : [];
